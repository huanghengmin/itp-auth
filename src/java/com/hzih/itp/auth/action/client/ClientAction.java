...
public class ClientAction extends ActionSupport {
    ...
    private Socket getSocket(String remoteIp,int remotePort,String localIp,int localPort) throws Exception{
...
//            System.setProperty("javax.net.ssl.trustStore", StaticField.CLIENT_KEY_STORE);
            ...
            socket = getSocket(serverIp,Integer.parseInt(serverPort),clientIp,Integer.parseInt(clientPort));
            if(socket != null){
            ...
            logger.warn("连接服务器失败 : " + e.getMessage());
    ...
    private String client_disconnect(String serverIp,String serverPort,String clientIp,String clientPort) {
        String msg = null,json = null;
        Socket s = null;
        try
        {
...
//            System.setProperty("javax.net.ssl.trustStore", StaticField.CLIENT_KEY_STORE);
            ...
            s = getSocket(serverIp,Integer.parseInt(serverPort),clientIp,Integer.parseInt(clientPort));
            if(s != null){
    ...
    private String getServers(String serverIp,String serverPort,String clientIp,String clientPort) {
        String msg = null,json = null;
        Socket s = null;
        try
        {
